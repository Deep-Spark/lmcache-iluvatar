...
# =============================================================================
# 2P2D PDBackend local-tiered — Prefiller 1 (sender)
#
# Clears only this instance's local_disk dir (PREFILLER1_CACHE_DIR).
# =============================================================================
...
LMCACHE_CONFIG_FILE_ARG=$(realpath "${PREFILLER1_CONFIG}")
LOCAL_DISK_CACHE_DIR="${PREFILLER1_CACHE_DIR}"
LMCACHE_RPC_PORT="${PREFILLER1_RPC_PORT}"
PREFILLER_PORT="${PREFILLER1_PORT}"
...
echo "Starting prefiller 1 (PDBackend sender, local-tiered)"

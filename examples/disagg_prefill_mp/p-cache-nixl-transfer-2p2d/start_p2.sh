...
# Prefiller 2: LMCache MP prefix reuse + NixlPush to selected decoder.
...
export VLLM_NIXL_SIDE_CHANNEL_PORT="${NIXL_PREFILL2_SIDE_CHANNEL_PORT}"
export NIXL_PREFILL_ENGINE_ID="${NIXL_PREFILL2_ENGINE_ID}"
export NIXL_KV_PORT="${NIXL_PREFILL2_KV_PORT}"
export PREFILLER_PORT="${PREFILLER2_PORT}"
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-${PREFILLER2_GPU}}"

echo "Starting P-cache+NIXL prefiller 2"

...
# Prefiller: load/store prefix cache through LMCache MP and send P/D KV through
# vLLM NIXL.
...
echo "Starting P-cache+NIXL prefiller"
echo "  NIXL_PREFILL_ENGINE_ID=${NIXL_PREFILL_ENGINE_ID}"
echo "  port=${PREFILLER1_PORT} connector=MultiConnector(MP+${NIXL_CONNECTOR})"

...
# Send one or two completion requests to vLLM agg + LMCache MP (GDS L1).
#
# Quick smoke test:
#   GDS_L1_PATH=/mnt/nvme/lmcache-gds-l1 bash curl.sh
#
# Compare COLD vs WARM:
#   GDS_L1_PATH=... WARM=1 bash curl.sh
#
# Start order:
#   GDS_L1_PATH=... bash start_lmcache_mp.sh
#   GDS_L1_PATH=... CUDA_VISIBLE_DEVICES=0,1 bash start_server.sh
#   GDS_L1_PATH=... WARM=1 bash curl.sh

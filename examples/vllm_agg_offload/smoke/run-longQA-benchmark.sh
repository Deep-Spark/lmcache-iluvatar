...
# Long-doc QA benchmark for aggregated vLLM + LMCache MP Server.
#
# Prerequisites: lmcache server and vLLM (start_lmcache_mp.sh, start_server.sh)
# are already running. Requests go directly to vLLM — no P/D proxy.
#
# Usage:
